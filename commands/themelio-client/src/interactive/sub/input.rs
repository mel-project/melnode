...
pub(crate) async fn format_interactive_sub_prompt(version: &str, name: &str) -> anyhow::Result<String> {
...
pub(crate) async fn command(prompt: &str) -> anyhow::Result<InteractiveSubCommand> {
