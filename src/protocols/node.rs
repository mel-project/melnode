...
use lru::LruCache;
use melnet2::{
    wire::tcp::{Pipeline, PipelineError, TcpBackhaul},
    Backhaul, Swarm,
};
...
use themelio_nodeprot::{
    NodeRpcClient, NodeRpcError, NodeRpcProtocol, NodeRpcService, StateSummary, Substate,
    TransactionError,
};
...
impl NodeProtocol {
    ...
    pub fn new(
        ...
        // TODO: 1. figure out if swarm::start_listen is all we need to do here?
...
async fn attempt_blksync(
    ...
    storage: &Storage,
) -> Result<Option<usize>, NodeRpcError<PipelineError>> {
